  ...
  return (
    <div className="px-6 pb-5 pt-3">
      <div
        ...
        onDrop={onDrop}
        className={`flex items-center gap-3 bg-[#16181f] border rounded-2xl px-4 py-3 shadow-xl transition-all ${isOver ? 'border-blue-500 bg-blue-500/5' : 'border-white/8 focus-within:border-blue-500/40'}`}
      >
        {/* Attach file button */}
        <button
        ...
        <input
          ...
          placeholder={isOver ? "Drop files to upload..." : "Ask about your documents..."}
      ...
      <p className="text-center text-[10px] text-slate-700 mt-2">Multiple files supported. Drag & drop active.</p>
    </div>
  )
}
